...
import { ListViewClass, ListViewColumnFunction, ListViewEditColumnProps, ListViewEditInputAttributes, listViewIptCn } from "../list-view";

const ListViewSelectBox: ListViewColumnFunction<ListViewEditColumnProps<number | string> & {
  ...
  let source = [], loading = true, listView: ListViewClass;

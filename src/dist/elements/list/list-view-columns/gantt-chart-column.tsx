...
const ListViewGanttChartColumn: ListViewColumnFunction<{
  ...
  let dragMode: "l" | "r" | "m" | "" = "", lastPos = 0, draged = false, listview: ListViewClass;
  ...
  return {
    ...
    headerCellInitialize: (column, initParams: InitParams) => {
      ...
      column.headerCellLabelElement.classList.remove(`${listViewCn}-lbl`);
...
.${listViewCn}-cell.${cn}-hcell {
  padding: 0px;
}
.${listViewCn}-cell.${cn}-cell {
...
.${listViewCn}-row[data-bdl] .${cn}-month {
  border-bottom: none;
}
.${cn}-date_wrap {
  ${CssPV.flex}
...
.${listViewCn}-cell[data-bdl] .${cn}-date {
  border-right: none !important;
}
.${cn}-row:last-child,
.${listViewCn}-row[data-bdl] .${cn}-row {
...
.${listViewCn}-row[data-oddeven="odd"] > .${cn}-cell .${cn}-date {
  border-right: 1px solid ${CssVar.lv.cell.bd.b};
}
.${listViewCn}-row[data-oddeven="odd"] > .${cn}-cell > .${cn}-row {
  border-bottom: 1px solid ${CssVar.lv.cell.bd.b};
}
.${listViewCn}-row[data-oddeven="even"] > .${cn}-cell .${cn}-date {
  border-right: 1px solid ${CssVar.lv.cell.bd.d};
}
.${listViewCn}-row[data-oddeven="even"] > .${cn}-cell > .${cn}-row {
  border-bottom: 1px solid ${CssVar.lv.cell.bd.d};
}
.${listViewCn}-row:hover > .${cn}-cell .${cn}-date,
.${listViewCn}-row:hover > .${cn}-cell > .${cn}-row {
  border-color: ${CssVar.lv.cell.hvr.row.bdc};
}
.${listViewCn}-row:hover > .${cn}-cell:hover .${cn}-date,
.${listViewCn}-row:hover > .${cn}-cell:hover > .${cn}-row {
  border-color: ${CssVar.lv.cell.hvr.cell.bdc};
}
.${cn}-date[data-w="0"] {
...
.${listViewCn}-row:hover .${cn}-cell[data-selected] {
  background: ${CssVar.lv.cell.act.bgc} !important;
}

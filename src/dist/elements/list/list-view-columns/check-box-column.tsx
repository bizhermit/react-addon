...
import { listViewCn, ListViewColumnFunction, ListViewEditColumnProps } from "../list-view";

const cn = "bh-lv_c-ckb";

const ListViewCheckBoxColumn: ListViewColumnFunction<ListViewEditColumnProps<{ value: boolean | number | string; checked: boolean; }> & {
...
.${cn}-hwrap > .${listViewCn}-lbl {
  flex: none;
}
.${cn}-hcell[data-align="left"] .${cn}-hwrap {
  align-items: flex-start;
}
.${cn}-hcell[data-align="left"] .${cn}-hwrap > .${listViewCn}-lbl {
  text-align: left;
}
.${cn}-hcell[data-align="center"] .${cn}-hwrap > .${listViewCn}-lbl {
  text-align: center;
}
.${cn}-hcell[data-align="right"] .${cn}-hwrap {
  align-items: flex-end;
}
.${cn}-hcell[data-align="right"] .${cn}-hwrap > .${listViewCn}-lbl {
  text-align: right;
}

...
const Page: NextPage = () => {
  const generageItems = (len = 10) => {
    return ArrayUtils.generateArray(len, idx => {
      ...
      return {
        ...
        number: idx,
        col0: `label-${idx}`,
        dateBox: DatetimeUtils.format(date),
        dateBox_1: DatetimeUtils.format(date, "yyyy-MM"),
        dateBox_2: DatetimeUtils.format(date, "yyyy"),
      };
    });
  }
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewDateBoxColumn({
      name: "dateBox",
      headerCellLabel: "DateBox",
    }));
    cols.push(DataViewDateBoxColumn({
      name: "dateBox_1",
      headerCellLabel: "YM",

...
import DataViewTimeBoxColumn from "../../../react-addon/dist/elements/list/data-view-columns/time-box-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewTimeBoxColumn({
      name: "timeBox",
      headerCellLabel: "TimeBox",
    }));
    cols.push(DataViewTimeBoxColumn({
      name: "timeBox_1",
      headerCellLabel: "HMS",

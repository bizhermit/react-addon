...
import Code from "../../../react-addon/dist/elements/code";
import FlexBox from "../../../react-addon/dist/elements/flex-box";

const CodePage: NextPage = () => {
return (
<FlexBox $padding $fto="fy">
<Code $language="ts" $fto="f">
{`import { NextPage } from "next";
...
const ButtonPage: NextPage = () => {
  ...
  const eref = useRef<HTMLButtonElement>();
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Button $icon="signin" disabled={disabled} style={{ width: 130 }}>button</Button>
          <Button $icon="signin" disabled={disabled} style={{ width: 130 }}>button</Button>
          <Button $icon="signin" $fillLabel disabled={disabled} style={{ width: 130 }}>button</Button>
          <Button $icon="signin" $fillLabel $borderless disabled={disabled} style={{ width: 130 }}>button</Button>
          <Button $icon="signin" disabled={disabled} $transparent $iconRight style={{ width: 130 }}>button</Button>

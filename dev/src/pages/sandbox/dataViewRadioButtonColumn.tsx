...
import DataViewRadioButtonColumn from "../../../react-addon/dist/elements/list/data-view-columns/radio-button-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewRadioButtonColumn({
      name: "radio",
      fixed: true,
    }));
    cols.push(DataViewRadioButtonColumn({

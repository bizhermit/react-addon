...
import DataViewCheckBoxColumn from "../../../react-addon/dist/elements/list/data-view-columns/check-box-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewCheckBoxColumn({
      name: "checkBox",
      headerCellLabel: "C",
    }));
    cols.push(DataViewCheckBoxColumn({

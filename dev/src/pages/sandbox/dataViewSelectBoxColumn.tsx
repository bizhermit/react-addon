...
import DataViewSelectBoxColumn from "../../../react-addon/dist/elements/list/data-view-columns/select-box-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    const source = () => {
      const s = ArrayUtils.generateArray(100, idx => {
        return {
          value: idx,
          label: `item ${idx}`,
        };
    ...
    cols.push(DataViewSelectBoxColumn({
      name: "selectBox",
      headerCellLabel: "SelectBox",
      source,
    }));
    cols.push(DataViewSelectBoxColumn({
      name: "selectBox_1",

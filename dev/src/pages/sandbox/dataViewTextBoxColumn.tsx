...
import DataViewTextBoxColumn from "../../../react-addon/dist/elements/list/data-view-columns/text-box-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewTextBoxColumn({
      name: "textBox",
      headerCellLabel: "TextBox",
    }));
    cols.push(DataViewTextBoxColumn({
      name: "textBox_1",
    }));

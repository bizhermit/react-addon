...
import DataViewGanttChartColumn from "../../../react-addon/dist/elements/list/data-view-columns/gantt-chart-column";
...
import DataView, { DataViewColumnProps, dataViewDefaultRowHeight, DataViewSelectMode, useDataView } from "../../../react-addon/dist/elements/list/data-view";
import DataViewDateBoxColumn from "../../../react-addon/dist/elements/list/data-view-columns/date-box-column";
import DataViewMultiStageColumn from "../../../react-addon/dist/elements/list/data-view-columns/multi-stage-column";
import DataViewReorderColumn from "../../../react-addon/dist/elements/list/data-view-columns/reorder-column";
import DataViewSliderColumn from "../../../react-addon/dist/elements/list/data-view-columns/slider-column";
...
const Page: NextPage = () => {
  ...
  const columns = useMemo(() => {
    ...
    cols.push(DataViewReorderColumn({
      name: "reorder",
      width: dataViewDefaultRowHeight(),
      fixed: true,
    }));
    cols.push(DataViewMultiStageColumn({
      name: "date",
      rows: [{
        columns: [
          DataViewDateBoxColumn({
            name: "scheduledFrom",
            disabled,
            sort: false,
    ...
    cols.push(DataViewSliderColumn({
      name: "slider",
    ...
    cols.push(DataViewGanttChartColumn({
      name: "chartDate",
      dateCellWidth: 30,
      // disabled,
      progressLine,
  ...
  return (
    <>
      ...
      <DataView
        ...
        $options={{
          header,
          headerHeight: dataViewDefaultRowHeight() * 2,
          footer,
          footerHeight: dataViewDefaultRowHeight() * 2,
          rowHeight: dataViewDefaultRowHeight() * 2,
          multiSelect,
          rowBorderless,
          colBorderless,
          rowNumber,

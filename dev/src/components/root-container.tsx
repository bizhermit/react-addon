...
const RootContainer: FC<{ children?: ReactNode; }> = ({ children }) => {
  ...
  const menuItems = useMemo(() => {
    ...
    return [
      ...
      toMenuItem("dataViewIconColumn", "IconColumn", "dataView"),
      toMenuItem("dataViewGroupColumn", "GroupColumn", "dataView"),
      toMenuItem("dataViewMultiStageColumn", "MultiStageColumn", "dataView"),
      toMenuItem("dataViewButtonColumn", "ButtonColumn", "dataView"),
      toMenuItem("dataViewCheckBoxColumn", "CheckBoxColumn", "dataView"),
      toMenuItem("dataViewRadioButtonColumn", "RadioButtonColumn", "dataView"),
      toMenuItem("dataViewTextBoxColumn", "TextBoxColumn", "dataView"),
      toMenuItem("dataViewNumericBoxColumn", "NumericBoxColumn", "dataView"),
      toMenuItem("dataViewSliderColumn", "SliderColumn", "dataView"),
      toMenuItem("dataViewSelectBoxColumn", "SelectBoxColumn", "dataView"),
      toMenuItem("dataViewDateBoxColumn", "DateBoxColumn", "dataView"),
      toMenuItem("dataViewTimeBoxColumn", "TimeBoxColumn", "dataView"),
      toMenuItem("dataViewReorderColumn", "ReorderColumn", "dataView"),
      toMenuItem("dataViewGanttChartColumn", "GanttChartColumn", "dataView"),
